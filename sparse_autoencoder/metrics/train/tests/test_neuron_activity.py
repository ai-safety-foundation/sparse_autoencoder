...
def test_neuron_activity_metric(
    ...
    """Test the NeuronActivityMetric for different scenarios.
    ...
    metric = NeuronActivityMetric(
        num_learned_features, num_components, threshold_is_dead_portion_fires
    )
